        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="space-y-6">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-600/20 border border-purple-500/30">
              <span class="icon-[tabler--sparkles] text-purple-600 size-5"></span>
            ...
            <div class="flex flex-col sm:flex-row gap-4 pt-4">
              <div class="relative flex-1 max-w-md">
                ...
                >
                  <span class="icon-[tabler--stars] size-5" :class="{ 'animate-spin': isGenerating }"></span>
          ...
          <div class="relative">
            <div class="glass-card p-8 rounded-3xl">
              <div class="aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-purple-600/20 to-pink-600/20 flex items-center justify-center relative">
                ...
                <div v-if="!isGenerating && !showImage" class="text-center space-y-4">
                  <span class="icon-[tabler--robot] text-purple-400 size-32"></span>
                ...
                <div v-if="isGenerating" class="text-center space-y-6 w-full px-8">
                  ...
                  <div class="relative">
                    ...
                    <span class="icon-[tabler--brain] text-purple-400 size-24 relative z-10 mb-4"></span>
                  </div>

                  <!-- Progress Bar -->
                  <div class="space-y-3">
                    <div class="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                      <div class="ai-progress-bar h-full bg-gradient-to-r from-purple-500 via-pink-500 to-purple-500"></div>
                    </div>
                  ...
                  <div class="space-y-2 text-left text-xs text-white/70">
                    <div class="ai-step flex items-center gap-2" style="animation-delay: 0s;">
                      <span class="icon-[tabler--check] text-green-400 size-4"></span>
                    ...
                    <div class="ai-step flex items-center gap-2" style="animation-delay: 1.6s;">
                      <span class="icon-[tabler--loader] text-purple-400 size-4 animate-spin"></span>
            ...
            <!-- Floating decoration -->
            <div class="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br from-pink-500 to-purple-600 rounded-full blur-3xl opacity-50 animate-pulse"></div>
            <div class="absolute -bottom-4 -left-4 w-32 h-32 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full blur-3xl opacity-50 animate-pulse" style="animation-delay: 1s;"></div>
          </div>
        </div>
      </div>
    </section>
